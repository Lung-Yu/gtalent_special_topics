...
('REGC', 'Reggiani Caseifici', 'Maurizio Moroni', 'Sales Associate', 'Strada Provinciale 124', 'Reggio Emilia', NULL, '42100', 'Italy', '0522-556721', '0522-556722'),
...
-- ========================================
-- Employees 資料 (9 筆) - 包含層級關係
-- ========================================
INSERT INTO Employees (EmployeeID, LastName, FirstName, Title, TitleOfCourtesy, BirthDate, HireDate, Address, City, Region, PostalCode, Country, HomePhone, Extension, Notes, ReportsTo, Salary) VALUES
(1, 'Davolio', 'Nancy', 'Sales Representative', 'Ms.', '1968-12-08', '2020-05-01', '507 - 20th Ave. E. Apt. 2A', 'Seattle', 'WA', '98122', 'USA', '(206) 555-9857', '5467', 'Education includes a BA in psychology from Colorado State University. She also completed The Art of the Cold Call.', 2, 55000.00),
(2, 'Fuller', 'Andrew', 'Vice President, Sales', 'Dr.', '1972-02-19', '2019-08-14', '908 W. Capital Way', 'Tacoma', 'WA', '98401', 'USA', '(206) 555-9482', '3457', 'Andrew received his BTS commercial and a Ph.D. in international marketing from the University of Dallas.', NULL, 95000.00),
(3, 'Leverling', 'Janet', 'Sales Representative', 'Ms.', '1983-08-30', '2020-04-01', '722 Moss Bay Blvd.', 'Kirkland', 'WA', '98033', 'USA', '(206) 555-3412', '3355', 'Janet has a BS degree in chemistry from Boston College. She has also completed a certificate program in food retailing management.', 2, 52000.00),
(4, 'Peacock', 'Margaret', 'Sales Representative', 'Mrs.', '1957-09-19', '2021-05-03', '4110 Old Redmond Rd.', 'Redmond', 'WA', '98052', 'USA', '(206) 555-8122', '5176', 'Margaret holds a BA in English literature from Concordia College and an MA from the American Institute of Culinary Arts.', 2, 54000.00),
(5, 'Buchanan', 'Steven', 'Sales Manager', 'Mr.', '1975-03-04', '2019-10-17', '14 Garrett Hill', 'London', NULL, 'SW1 8JR', 'UK', '(71) 555-4848', '3453', 'Steven Buchanan graduated from St. Andrews University, Scotland, with a BSC degree.', 2, 75000.00),
(6, 'Suyama', 'Michael', 'Sales Representative', 'Mr.', '1983-07-02', '2019-10-17', 'Coventry House Miner Rd.', 'London', NULL, 'EC2 7JR', 'UK', '(71) 555-7773', '428', 'Michael is a graduate of Sussex University (MA, economics) and the University of California at Los Angeles (MBA, marketing).', 5, 58000.00),
(7, 'King', 'Robert', 'Sales Representative', 'Mr.', '1980-05-29', '2020-01-02', 'Edgeham Hollow Winchester Way', 'London', NULL, 'RG1 9SP', 'UK', '(71) 555-5598', '465', 'Robert King served in the Peace Corps and traveled extensively before completing his degree in English at the University of Michigan.', 5, 56000.00),
(8, 'Callahan', 'Laura', 'Inside Sales Coordinator', 'Ms.', '1978-01-09', '2021-03-05', '4726 - 11th Ave. N.E.', 'Seattle', 'WA', '98105', 'USA', '(206) 555-1189', '2344', 'Laura received a BA in psychology from the University of Washington.', 2, 48000.00),
(9, 'Dodsworth', 'Anne', 'Sales Representative', 'Ms.', '1986-01-27', '2021-11-15', '7 Houndstooth Rd.', 'London', NULL, 'WG2 7LT', 'UK', '(71) 555-4444', '452', 'Anne has a BA degree in English from St. Lawrence College.', 5, 51000.00);

-- Orders 和 OrderDetails 資料將在下一個腳本中大量生成
...
-- ========================================
-- EmployeeTerritories 資料 - 員工與區域的多對多關聯
-- ========================================
...
-- ========================================
-- CustomerDemographics 資料
-- ========================================
INSERT INTO CustomerDemographics (CustomerTypeID, CustomerDesc) VALUES
('TYPE1', 'Small Business'),
('TYPE2', 'Medium Business'),
('TYPE3', 'Large Corporation'),
('TYPE4', 'Individual Consumer');

-- ========================================
-- 初始 Orders 和 OrderDetails 資料（少量範例）
-- 大量資料將在 04-generate-performance-data.sql 中生成
-- ========================================

-- 插入一些範例訂單以確保資料庫結構可用
INSERT INTO Orders (OrderID, CustomerID, EmployeeID, OrderDate, RequiredDate, ShippedDate, ShipVia, Freight, ShipName, ShipAddress, ShipCity, ShipPostalCode, ShipCountry) VALUES
(10248, 'VINET', 5, '2024-07-04 00:00:00', '2024-08-01 00:00:00', '2024-07-16 00:00:00', 3, 32.38, 'Vins et alcools Chevalier', '59 rue de l''Abbaye', 'Reims', '51100', 'France'),
(10249, 'TOMSP', 6, '2024-07-05 00:00:00', '2024-08-16 00:00:00', '2024-07-10 00:00:00', 1, 11.61, 'Toms Spezialitäten', 'Luisenstr. 48', 'Münster', '44087', 'Germany'),
(10250, 'HANAR', 4, '2024-07-08 00:00:00', '2024-08-05 00:00:00', '2024-07-12 00:00:00', 2, 65.83, 'Hanari Carnes', 'Rua do Paço, 67', 'Rio de Janeiro', '05454-876', 'Brazil'),
(10251, 'VICTE', 3, '2024-07-08 00:00:00', '2024-08-05 00:00:00', '2024-07-15 00:00:00', 1, 41.34, 'Victuailles en stock', '2, rue du Commerce', 'Lyon', '69004', 'France'),
(10252, 'SUPRD', 4, '2024-07-09 00:00:00', '2024-08-06 00:00:00', '2024-07-11 00:00:00', 2, 51.30, 'Suprêmes délices', 'Boulevard Tirou, 255', 'Charleroi', 'B-6000', 'Belgium');
...
-- 基礎資料插入完成
-- ========================================
SELECT 'Northwind Sample Data Loaded Successfully!' AS Status;
SELECT CONCAT('Total Categories: ', COUNT(*)) AS Info FROM Categories
UNION ALL
SELECT CONCAT('Total Suppliers: ', COUNT(*)) FROM Suppliers
UNION ALL
SELECT CONCAT('Total Products: ', COUNT(*)) FROM Products
UNION ALL
SELECT CONCAT('Total Customers: ', COUNT(*)) FROM Customers
UNION ALL
SELECT CONCAT('Total Employees: ', COUNT(*)) FROM Employees
UNION ALL
SELECT CONCAT('Total Orders (initial): ', COUNT(*)) FROM Orders;
